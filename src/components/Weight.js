...
const Trending = () => {
    return (
        <>
            <div className='mx-4'>
                <h1 className='border-b border-b-gray-600 w-auto text-2xl font-bold rounded-sm mx-8 my-3 py-5 text-white'>Weight Loss</h1>
                <p className='mx-8 -mt-[0.90rem] border-b-2 border-b-gray-600 w-20'></p>
                <div className='flex mx-4 mt-4'>
                    <div className='w-11/12'>
                        ...
                        <h2 className='mx-4 font-bold  hover:underline text-white'>Punch The Fat Away! - Fitness Boxing For Weight Loss</h2>
                    ...
                    <div className='w-11/12'>
                        ...
                        <h2 className='mx-4 font-bold  hover:underline text-white'>Lose Weight - One Rep At A Time</h2>
                    ...
                    <div className='w-11/12'>
                        ...
                        <h2 className='mx-4 font-bold hover:underline text-white'>Yoga For Weight & Fat Loss - The Ultimate Guide</h2>
                    ...
                    <div className='w-11/12'>
                        ...
                        <h2 className='mx-4 font-bold hover:underline text-white'>The H-To-O Of Water Weight: Everything You Need To Know</h2>
